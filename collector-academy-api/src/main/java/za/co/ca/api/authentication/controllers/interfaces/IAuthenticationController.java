package za.co.ca.api.authentication.controllers.interfaces;
...
//            description = "This API registers a new user if the user is not already present in the records, and sends an email to the user for verification."
//    )
//    @ApiResponses(
//            value = {
//                @ApiResponse(
//                        responseCode = "201",
//                        description = "User has been saved in records, but still needs to be verified",
//                        content = @Content(
...
//                @ApiResponse(
//                        responseCode = "500",
//                        description = "Internal Server Error: Failed to send OTP email. Please try again later.",
//                        content = @Content(
//                                mediaType = "application/json",
//                                schema = @Schema(
//                                        implementation = Error.class
